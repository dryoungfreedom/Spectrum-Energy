...
const ROLES = [
  ...
  { id:"refractor",  name:"Refractor",  desc:"Bends / slows energy through a medium (index of refraction ≠ 1)", icon:"◠", group:"change" },
  { id:"diffractor", name:"Diffractor", desc:"Deflects / separates energy by wavelength via periodic structure interference (Bragg diffraction in crystals — the gamma-band analog of a prism)", icon:"⋈", group:"change" },
...
const ROLE_COLORS = {
  ...
  diffractor:{ bg:"#2C3E7A", text:"#A8C0F0" },
...
const CONTROL_GROUPS = [
  ...
  { id:"change", label:"CHANGE", color:"#A9DFBF", desc:"Direct, redirect, modify, attenuate, filter, or transform energy in transit", roles:["conductor","reflector","refractor","diffractor","resistor","polarizer","converter","transformer"] },
...
{symbol:"C",name:"Carbon",Z:6,config:"[He] 2s² 2p²",p:0,bands:{electron:["resistor"],radio:["insulator","resistor"],microwave:["absorber","converter","resistor"],infrared:["absorber"],visible:["absorber","refractor"],ultraviolet:["absorber"],xray:["transparent","conductor","refractor","diffractor","polarizer"],gamma:["transparent","diffractor"],thermal:["conductor","absorber"],magnetic:["resistor"],neutron:["transparent","reflector","refractor"]}},
...
{symbol:"Ge",name:"Germanium",Z:32,config:"[Ar] 3d¹⁰ 4s² 4p²",p:0,bands:{electron:["resistor"],radio:["insulator","converter","resistor"],microwave:["transparent","converter","refractor"],infrared:["transparent","converter","resistor","refractor"],visible:["absorber","converter","resistor","refractor"],ultraviolet:["absorber"],xray:["transparent","conductor","diffractor","polarizer"],gamma:["transparent","diffractor"],thermal:["conductor"],magnetic:["resistor"],neutron:["resistor"]}},
